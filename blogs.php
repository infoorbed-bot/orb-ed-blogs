  ...
  <div class=" blogPage">
    ...
    <div class="row">
      <div class="leftcolumn">
        <div class="card">
          <h2>Stepping Into A Level? Here's How Orb-Ed Can Help</h2>
          <h5>Jan 7, 2023</h5>
          <h5>-</h5>
          ...
          <h5>Make The Most Of Your A Level Experience</h5>
          ...
          <p>Want to explore Orb-Ed? <a href="https://lms.orb-ed.pk/account/register" style="color: red">Click here</a>
            to avail your free trail.</p>
        </div>
      </div>
    </div>
